...
/// @title IDegenSpyV1LpLocker
/// @notice Permanent seven-position custody and raw-SPY fee routing for SPY V4.1 launches.
interface IDegenSpyV1LpLocker is ILaunchFeeClaimer {
    ...
    function collectRewards(address token) external returns (uint256 tokenFees, uint256 rawSpyFees);
