...
/// @notice Real PoolManager/router fixture compiled across the pinned 0.8.26/0.8.28 boundary.
abstract contract DegenHubV4Fixture is Test {
    ...
    function _setUpV4Infrastructure() internal {
        bytes memory initCode = abi.encodePacked(
            vm.getCode("../contracts-v4/out/PoolManager.sol/PoolManager.json"),
    ...
    function _setUpV4PositionManager() internal {
        bytes memory permit2Code = vm.getCode("../contracts-v4/out/Permit2.sol/Permit2.json");
        ...
        bytes memory positionManagerCode = abi.encodePacked(
            vm.getCode("../contracts-v4/out/PositionManager.sol/PositionManager.json"),
    ...
    function _swap(bool zeroForOne, int256 amountSpecified) internal returns (BalanceDelta delta) {
        return _swap(zeroForOne, amountSpecified, zeroForOne ? MIN_PRICE_LIMIT : MAX_PRICE_LIMIT);
    }
