...
/// @notice Narrow fixed-supply ERC-20 used by every DegenHood v4 factory launch.
/// @dev Adapted from DegenHood's v3 token. Fee, LP, treasury, callback, mint, transfer-tax,
///      allowlist, and wallet-limit capabilities are intentionally absent.
