...
/// @title DegenFeeMath
/// @notice Full-precision fee arithmetic shared by v4 quote and settlement paths.
library DegenFeeMath {
    ...
    /// @dev Gross-up can produce one rounding wei above floor(gross * rate); that wei is explicit
    ///      protocol dust so the approved nominal temporary split and WETH conservation both hold.
